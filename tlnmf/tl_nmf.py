...
def tl_nmf(Y, K, Phi=None, W=None, H=None, regul_type='sparse',
           regul=1e4, max_iter=1000, n_iter_optim=5, tol=1e-6, verbose=False,
           rng=None):
    ...
    regul_type : str, optional
        Type of regularization. 'sparse' or 'smooth'.
